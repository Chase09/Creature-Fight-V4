...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        for(int i = 0; playerTwoLose == true && i < playerOneCreatures.length; i++)
        {
    ...
    /**
     * This is the code to change the player ones creature.
     *          
     * @param There is a string parameter called creature
     * @return Nothing is being returned
     */
    //TODO (15): Declare a changePlayerOne method that will be accessed by other classes, does not return anything and has a String parameter called creature
    public void changePlayerOne(String creature)
    {
        ...
        //TODO (19): Set the playerOneMenusAdded variable to reflect that there are no player one menus anymore
        playerOneMenusAdded = false;
    }

    /**
     * This is the code to change the player twos creature.
     *          
     * @param There is a string parameter called creature
     * @return Nothing is being returned
     */
    //TODO (20): Declare a changePlayerTwo method that will be  accessed by other classes, does not return anything and has a String parameter called creature
    public void changePlayerTwo(String creature)
    {
        ...
        //TODO (24): Set the playerTwoMenusAdded variable to reflect that there are no player one menus anymore
        playerTwoMenusAdded = false;
    }
     ...
     */
    public Creature getNewOneCreature(int idx)
    {
        return playerOneCreatures[idx];
    }
     ...
     */
    public Creature getNewTwoCreature(int idx)
    {
        return playerTwoCreatures[idx];
    }
